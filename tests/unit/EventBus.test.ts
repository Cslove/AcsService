...
describe('EventBus', () => {
  ...
  describe('事件订阅和发布', () => {
    it('应该能够订阅和发布事件', () => {
      ...
      const data = { message: { id: '1', sessionId: 'session-1', role: 'user', content: [], timestamp: new Date() } };
  ...
  describe('SSE 事件', () => {
    it('应该能够发布 SSE 事件', () => {
      ...
      const sseEvent = {
        ...
        data: { message: { id: '1', sessionId: 'session-1', role: 'user', content: [], timestamp: new Date() } },
        timestamp: Date.now(),
        eventId: 'event-1',
      };
